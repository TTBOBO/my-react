...
class timeArticleList extends Component {
    constructor(props) {
        super(props);
        this.state = {
            curHeight: 0
    ...
    render() {
        ...
        return (
            <div style={{ height: '100%' }} className={this.props.header ? 'content' : ''} id="article-view">
                <Scroll ref="scroll" pullDownRefresh={false}  loadMore={(num) => this.initList(num)} header={this.props.header} curHeight={1}>
...
export default timeArticleList;